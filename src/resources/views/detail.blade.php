...
<form class="reservation__form" action="/reservation" method="POST">
    ...
    <div class="reservation__form--item">
        ...
        <input id="reservation__form--input-date" type="date" name="date">
    ...
    <div class="reservation__form--confirmation">
        <table class="reservation__form--confirmation-table">
            ...
            <tr class="reservation__form--confirmation-row">
                ...
                <td id="reservation__form--confirmation-date"></td>
            </tr>
            <tr class="reservation__form--confirmation-row">
                <th class="reservation__form--confirmation-header">Time</th>
                <td id="reservation__form--confirmation-time"></td>
            </tr>
            <tr class="reservation__form--confirmation-row">
                <th class="reservation__form--confirmation-header">Number</th>
                <td id="reservation__form--confirmation-number"></td>
            </tr>
        </table>
    </div>
    <div class="reservation__form--button">
        <button class="reservation__form--button-submit">予約する</button>
    </div>    
</form>
